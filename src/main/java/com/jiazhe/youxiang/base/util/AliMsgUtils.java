...
public class AliMsgUtils {
     ...
     * 发送验证短信
     */
    public static SendSmsResponse sendVerificationCodeMsg(String mobile, String code) {
        String[] params = {code};
        String templateContent = "${code}";
        return sendMsg(mobile, ver_code_TemplateCode, templateContent, params);
    }

    /**
     * 发送业务短信
     */
    public static SendSmsResponse sendMsg(String mobile, String templateCode, String templateContent, String[] params) {
        //设置超时时间-可自行调整
