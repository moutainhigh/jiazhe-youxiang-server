...
public class APISysUserController extends BaseController{
    ...
    @ApiOperation(value = "查询所有用户信息", httpMethod = "GET", response = SysUserResp.class, responseContainer = "List",notes = "查询所有用户信息")
    ...
    @ApiOperation(value = "分页查询用户信息", httpMethod = "GET", response = SysRoleResp.class, responseContainer = "List",notes = "分页查询用户信息")
    ...
    @ApiOperation(value = "根据id删除用户信息（包含对应角色）", httpMethod = "POST", notes = "根据id删除用户信息（包含对应角色）")
    ...
    @ApiOperation(value = "根据id获取用户信息（包含角色）", httpMethod = "GET", response = UserWithRoleResp.class, notes = "根据id获取用户信息（包含角色）")
    ...
    @ApiOperation(value = "【新建、修改】保存用户信息", httpMethod = "POST", notes = "【新建、修改】保存用户信息")
