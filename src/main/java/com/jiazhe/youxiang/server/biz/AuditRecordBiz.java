...
public class AuditRecordBiz {
    ...
    public List<AuditRecordDTO> getList(String customerMobile, String customerName, Byte status, Byte chargeReceiptStatus, String submitterName, String pointCodes,Date submitStartTime, Date submitEndTime, Paging paging) {
        return auditRecordService.getList(null, customerMobile, customerName, status, chargeReceiptStatus, submitterName, pointCodes,submitStartTime, submitEndTime, paging);
    }

    public List<AuditRecordDTO> getSubmitterList(Integer submitterId, String customerMobile, Byte status, Paging paging) {
        return auditRecordService.getList(submitterId, customerMobile, null, status, null, null, null,null, null, paging);
    }
