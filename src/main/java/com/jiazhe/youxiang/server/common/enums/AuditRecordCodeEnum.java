...
public enum AuditRecordCodeEnum {
    ...
    RECORD_CNANOT_CHANGE(111011, "RECORD_CNANOT_CHANGE", "该条记录已经提交或审核，不允许修改"),
    ...
    CHARGE_RECEIPT_EXCHANGE_POINT_ERROR(111025,"CHARGE_RECEIPT_EXCHANGE_POINT_ERROR","小票积分填写错误，请重新检查"),;
