...
public enum PointCodeEnum {
    ...
    QRCODE_DECRYPT_ERROR(116024, "QRCODE_DECRYPT_ERROR", "二维码解密失败"),
    QRCODE_HAS_CHARGED(116025, "QRCODE_HAS_CHARGED", "该二维码已经兑换过"),
    CUSTOMER_IS_NOT_LOGIN(116026, "CUSTOMER_IS_NOT_LOGIN", "客户没有登录"),
    QRCODE_CHARGE_TIME_NOT_YET(116027, "QRCODE_CHARGE_TIME_ERROR", "积分扣减24小时后方可兑换"),
    QRCODE_CHARGE_TIME_ERROR(116028, "QRCODE_CHARGE_TIME_ERROR", "交易时间解析异常"),
    QRCODE_HAS_NOT_BATCH(116029, "QRCODE_HAS_NOT_BATCH", "没有找到可兑换的批次"),
    QRCODE_BATCH_ERROR(116030, "QRCODE_BATCH_ERROR", "二维码兑换批次记录异常"),
    ;
