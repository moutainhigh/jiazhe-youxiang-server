...
document.write("<script language='javascript' src='/static/ace-master/js/moment-locale-zh-cn.js'></script>");
...
document.write("<script language='javascript' src='/static/ace-master/js/bootstrap-multiselect.min.js'></script>");
