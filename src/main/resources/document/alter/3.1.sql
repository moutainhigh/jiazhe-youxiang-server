/**
 商家订单模块
 */
alter table partner_order_info modify column status TINYINT(4) NOT NULL DEFAULT '1' COMMENT '订单状态 1待派单,2待服务,3已完成,4已取消';
...
alter table audit_record modify column point_ids VARCHAR(1023) NOT NULL DEFAULT '' COMMENT '当兑换类型为1时，记录积分卡id集合';
...
alter table recharge_card_exchange_code modify column expiry_type TINYINT(4) NOT NULL DEFAULT '0' COMMENT '过期时间类型 0-充值卡过期时间，1-兑换之日起多少天有效，2-激活之日起多少天有效';
alter table voucher_exchange_code_batch modify column expiry_type TINYINT(4) NOT NULL DEFAULT '0' COMMENT '过期时间类型 0-代金券过期时间，1-兑换之日起多少天有效，2-激活之日起多少天有效';
alter table voucher_exchange_code modify column expiry_type TINYINT(4) NOT NULL DEFAULT '0' COMMENT '过期时间类型 0-代金券过期时间，1-兑换之日起多少天有效，2-激活之日起多少天有效';